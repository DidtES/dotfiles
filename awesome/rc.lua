...
beautiful.init(awful.util.getdir("config") .. "/themes/cafe/theme(1).lua")
...
awful.spawn.with_shell("feh --bg-fill /home/didtes/Изображения/wp11176849-russia-4k-wallpapers.jpg")
...
globalkeys = gears.table.join(
    ...
    --Rofi
    awful.key({ modkey,           }, "d", function () awful.spawn.with_shell("rofi -show drun -config ~/.config/rofi/config -theme ~/.config/rofi/launchers/type-4/style-4.rasi ") end,
              {description = "Rofi Run", group = "launcher"}),
    --screenshot
    awful.key({ modkey,           }, "c", function () awful.spawn.with_shell("xfce4-screenshooter -f -s /home/didtes/Музыка") end,
              {description = "Rofi Run", group = "launcher"}),
...
--~/.config/rofi/launchers/type-4/style-3.rasi
-- Set keys
...
local function update_keyboard_layout()
    ...
    if layout == " ru " or layout == "ru" then
        mykeyboardlayout.widget:set_markup('<span font="sans bold 12">ru</span>')
    else
        mykeyboardlayout.widget:set_markup('<span font="sans bold 12">us</span>')
    end
end
...
--    awful.key({ modkey,           }, "d", function () awful.spawn.with_shell("rofi -show run -config ~/.config/rofi/config -theme ~/.config/rofi/theme.rasi") end)
